/*RANG NYA GA MAU NGOMONG KASAR TAPI KALO LIAT ORANG YANG JUAL SC INI GUA PEN NGOMONG ANJING BABI SETAN LAKNAT GA USAH JUAL SC FREE INI TAI......
...
let photo =["https://graph.org/file/7f43a7120c04608e83c1c.jpg","https://graph.org/file/7f43a7120c04608e83c1c.jpg","https://graph.org/file/7f43a7120c04608e83c1c.jpg","https://graph.org/file/7f43a7120c04608e83c1c.jpg","https://graph.org/file/7f43a7120c04608e83c1c.jpg"] 
...
newsletterJid:"https://wa.me/c/6285808492274",
serverMessageId: 100,
newsletterName: "Jennie Kim"
}, 
...
mediaUrl:"https://wa.me/c/6285808492274"
}
}
...
let url = `https://youtu.be/MVgeiiomiWE?si=M2dlNflTvju-3fN`
...
let url = `https://youtu.be/MVgeiiomiWE?si=M2dlNflTvju-E3N`
let links = [
"https://telegra.ph/file/bee810ed93da9dafa7b43.jpg",
"https://telegra.ph/file/bee810ed93da9dafa7b43.jpg",
"https://telegra.ph/file/bee810ed93da9dafa7b43.jpg"
]
...
let data = global.db.data.others['runtime']
let time = (new Date - data.runtime) || "Tidak terdeteksi"
let url = `https://youtu.be/MVgeiioiWE?si=M2dlNflTvju-E3fN`
let links = [
"https://telegra.ph/file/bee810ed93da9dafa7b43.jpg",
"https://telegra.ph/file/bee810ed93da9dafa7b43.jpg",
"https://telegra.ph/file/bee810ed93da9dafa7b43.jpg"
...
case 'sc': case 'script':{
  let img = { url : `${ehanzUrl}`, type : "image/jpeg" }
let url = `https://youtu.be/MVgeiomiWE?si=M2dlNflTvj-E3fN`
let scnya = `SCRIPT : https://www.youtube.com/@`
...
conn.sendMessage(m.chat, {
      ...
      thumbnailUrl: 'https://telegra.ph/file/bee810ed93da9dafa7b43.jpg',
      mediaType: 1,
      renderLargerThumbnail: true
      }}})
      conn.reply(m.sender, `Grub Rangel - Multidevice\n\nhttps://chat.whatsapp.com/Fguw4KxsP6qCBm9RfZvOS`, m)
}
break
case 'rules':{
let teks =`
...
let nono = await jancok.toFile(stok)
let nah = fs.readFileSync(nono)
await conn.sendMessage(from, { contextInfo: {externalAdReply: {showAdAttribution: true, title: `${botName}`, mediaType: 3,  renderLargerThumbnail : true,thumbnailUrl:'https://telegra.ph/file/5d4d567f3ab24ffd26e1a.jpg',sourceUrl: 'https://www.instagram.com/'
}}, sticker: nah }, { quoted: m })   																																
await fs.unlinkSync(stok)
await fs.unlinkSync(media)
} else {
...
case 'quotessad':{
  if (!isGroup) return onlyGroup()
let url = `https://youtu.be/MVgeiioiWE?si=M2dlNflTvju-EfN`
...
conn.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `${week} , ${calender}ㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `wa.me/6285808492274`,}
...
conn.sendMessage(from, { contextInfo: { externalAdReply: { showAdAttribution: true,
title: `RangelChan`,body:`⌜ ${ucapanWaktu} ⌟`,previewType:"PHOTO",thumbnail: its,sourceUrl: `https://www.instagram.com/`,}
...
if (!args[0]) return setReply(`Penggunaan ${command} nomor\nContoh ${command} +${6285808492274}`)
let nosend = "+" + q.split("|")[0].replace(/[^0-9]/g, '')
if (args[0].startsWith(`+${6285808492274}`)) return setReply('Tidak bisa call ke nomor ini!')
